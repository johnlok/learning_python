#solution for http://www.pythonchallenge.com/pc/def/equality.html
...
testRE = re.compile('[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]')
matchObj = re.findall(testRE, messy_string)
